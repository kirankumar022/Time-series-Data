...
library(tseries)
library(readxl)
CocaCola_Sales_Rawdata <- read_excel("E:/Assignments/Assignments week 10/Assignments/assignment data sets/Airlines Data.xlsx")
View(CocaCola_Sales_Rawdata)

# Converting data into time series object
?ts
colnames(CocaCola_Sales_Rawdata)=c("date","Sales")

tssales <- ts(CocaCola_Sales_Rawdata$Sales, frequency = 4, start = c(96))
View(tssales)
